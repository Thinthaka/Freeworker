...
<nav >
  <div class="item-image"><img src="<?php echo BASEURL; ?>/public/assets/img/icons/ee-logo.png" class="logo"></div>
   <a href="<?php echo BASEURL.'/allModerators/mod' ?>"><div class="item selected"><img src="<?php echo BASEURL; ?>/public/assets/img/icons/icons8-user-resume-96.png" class="sidebar-icons"><span>Moderators</span></div></a>
...
<table >
  <tr style="background-color: #0c5f79;color:white">
    <td style="background-color: #0c5f79;">Moderator</td>
    <td style="background-color: #0c5f79;">First name</td>
    <td style="background-color: #0c5f79;">Last name</td>
    <td style="background-color: #0c5f79;">E mail</td>
    <td style="background-color: #0c5f79;">Start Date</td>
  </tr>
 <?php 
$result=$data['results'];
