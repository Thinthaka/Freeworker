...
class verification extends exlFramework
{
    ...
    public function index()
    {
        ...
        Please confirm that you want to use this email address as your Freeworker  $accountType account email address.<br><br>
        ...
        font-weight: 500;font-size: 14px;background-color: #0c5f79;'>Verify My Email Address</button></a>
        <br><br>OR Enter OTP <b><span style='font-size: 16px'>$otp</span></b><br>Thank you for joining with Freeworker .";
        $AltBody = "Please confirm that you want to use this as your Freeworker  account email addres.Enter OTP $otp ";
