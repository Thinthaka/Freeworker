<?php
    ...
    private function throwAccountError($userName)
    {
        ...
        if ($user['verificationStatus']=='0') 
        {
            ...
            return "Your Account is BLOCKED Contact Freeworker  !";
        }
    }
    private function notify($userName)
    {
        ...
        if ($user) { 
            ...
            $Subject = 'Logged in Alert- Freeworker ';
            
            $Body= "<b> <p style='font-family:Segoe UI, Tahoma, Geneva, Verdana, sans-serif;font-size:15px;'>Hi $fisrtName ,</b><br>
            You are logged in to your Freeworker  Account.
            <br><br>
            If this is not you,you can reset your Freeworker  account password by clicking
