...
class forgetPassword extends exlFramework
{
    ...
    public function submit()
    {
        ...
        if ($user) { 
            ...
            No need to worry! You can simply reset your Freeworker  account password by clicking the button below:<br><br>
            ...
            font-weight: 500;font-size: 14px;background-color: #0c5f79;'>Reset My Password</button></a><br><br>
