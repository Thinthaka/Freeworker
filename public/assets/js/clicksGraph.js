...
$(document).ready(function () {
  $.ajax({
    ...
    url: `/Freeworker /sellerAnalytics/getClicksData/${adID}`, //retrieve relevant data from this location
    method: "GET",
...
$(document).ready(function () {
  $.ajax({
    //to perform an ajax request
    url: `/Freeworker /sellerAnalytics/getRequestsData/${adID}`, //retrieve relevant data from this location
    method: "GET",
    success: function (data) {
      //executed when the ajax request succeeds
      var week = [];
