$(document).ready(function () {
    $.ajax({
      ...
      url: `/Freeworker /adminDashboard/getRevenueData`, //retrieve relevant data from this location
      method: "GET",
  ...
  $(document).ready(function () {
    $.ajax({
      //to perform an ajax request
      url: `/Freeworker /adminDashboard/getVisitorByCountry`, //retrieve relevant data from this location
      method: "GET",
      success: function (data) {
        //executed when the ajax request succeeds
        var country = [];
  ...
  $(document).ready(function () {
    $.ajax({
      //to perform an ajax request
      url: `/Freeworker /adminDashboard/getVistorByDate`, //retrieve relevant data from this location
      method: "GET",
      success: function (data) {
        //executed when the ajax request succeeds
        var date = [];
