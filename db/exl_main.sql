...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 22, 2022 at 06:26 PM
...
CREATE TABLE `advertisement` (
  ...
  `totRate` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ad_reviews` (
  ...
  `adverticementId` int(11) NOT NULL,
...
(38, 'Freeworker -master.zip', 0, '2021-03-28 00:44:53', 33, 0, 'not-final'),
...
CREATE TABLE `seller` (
  ...
  `totalMainRate` int(11) NOT NULL DEFAULT 0,
  `totalCommunicationRate` int(11) NOT NULL DEFAULT 0,
  `totalDeliveringRate` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `user` (
  ...
  `verificationOTP` int(11) NOT NULL,
...
('chamkaviz', 'Kavinda', 'Liyanaarachchi', '1999-03-29', 'chamkaviz2@gmail.com', 0, 0, 0, '$2y$10$vQoOU2zexgfle./QGANDp.kRtTSNHDUj5u4xrZkpfEdFRdzXlK0he', ''),
('charitha', 'Charitha', 'Attalage', '2020-11-20', 'charitha@gmail.com', 0, 1, 12345, 'fc5e038d38a57032085441e7fe7010b0', 'admin.png'),
('chathura', 'Chathura', 'Rathnayake', '2020-11-11', 'crathnayake@gmail.com', 0, 1, 1255, '$2y$10$vQoOU2zexgfle./QGANDp.kRtTSNHDUj5u4xrZkpfEdFRdzXlK0he', 'chathura1605478069.jpg'),
...
('thina', 'thinthaka', 'dhananjaya', '2000-02-03', 'thina@gmail.com', 0, 0, 0, '$2y$10$q16Q3i2GfXPB8UlC/UVpOO1NoBi524bJViLsDGs4ORf6O/foI72nu', ''),
('thina3', 'pissu', 'thinthaka', '1999-03-30', 'thina3@gmail.com', 1, 1, 0, '12345', ''),
('thina5', 'badu', 'thina', '1999-12-12', 'thinthaka5@gmail.com', 0, 1, 0, '$2y$10$BqXNul9AGObAM3NLzpG69ODVo0j98Q/ENj/Z9PpWN1Fk5Zm8pfN/S', ''),
('thina6', 'pake', 'thina', '1999-12-12', 'thina7@gmail.com', 0, 1, 0, '$2y$10$4VwGHixuKl5DbiZmnHHtueHts80PwU1ADtU09jnx8lNvKNWoXHCKK', ''),
('thinas', 'thinthaka ', 'siriwardana', '1999-03-31', 'thina2@gmail.com', 0, 0, 0, '$2y$10$eD/5.wJDmhzrF6Rd2NQK4OiCQ/EvQaKM5wFcfe1jlDjqBdxS8yrnC', ''),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`dilan`@`localhost` SQL SECURITY DEFINER VIEW `requeststable`  AS SELECT concat(year(`job`.`date`),'/',week(`job`.`date`,0)) AS `theWeek`, count(`job`.`jobId`) AS `requests` FROM `job` WHERE `job`.`adId` = '42' GROUP BY concat(year(`job`.`date`),'/',week(`job`.`date`,0)) ORDER BY year(`job`.`date`) ASC, week(`job`.`date`,0) ASC  ;
